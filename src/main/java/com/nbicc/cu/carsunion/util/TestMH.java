...
//        System.out.println(MHUtil.getMHVehicleDetails("137"));
       ...
       // System.out.println(MHUtil.getMHVehicleTripList("3080","2017-11-01T12:01:46+08:00","2017-11-22T16:55:46+08:00"));
        //System.out.println(MHUtil.controlMHVehicle("16280","0","lock",0));
        //List<String> param = new ArrayList<>();
        //param.add("autoLock");
        //System.out.println(MHUtil.getMHVehicleSetting("3080",param));
        //System.out.println(String.format("%x%x",(System.currentTimeMillis()/1000)%(int)Math.pow(16,7),(int)(16*Math.random())));
    }
}
